...
def ParseDate(StringToParse):
    ...
    # FIXME: This pattern is not correct. 
    # I'm testing stuff in a Python shell and on regex101.com to find something that will work.
    # @dstrait, 2020/05/14
    ...
    # FIXME: will this work, once Iv'e got the RE pattern worked out?
